...
<li id="<?php
echo $metaKey->getKey(); ?>-<?php
echo $term->term_id; ?>" class="toggle">
    <label class="selectit">
        ...
        echo $term->term_id; ?>"
               ...
               echo $term->term_id; ?>"
            <?php
            checked(true, in_array($term->term_id, $metaValues)); ?>>
        <?php
        echo $term->name; ?>
    ...
    if (!empty($subterms)) : ?>
        ...
        <ul class="children">
            ...
            foreach ($subterms as $subterm) : ?>
                ...
                <?php
                $listItem = new Template('partials/meta-key-term-default.php', array(
                    'term' => $subterm,
                    'metaKey' => $metaKey,
                )); ?>
                <?php
